...
define([
  'core',
  'presentationeditor/main/app/collection/SearchPanel',
  'presentationeditor/main/app/view/SearchPanel'
], function () {
  'use strict';

  PE.Controllers.SearchPanel = Backbone.Controller.extend(_.extend({
      models: [],
      collections: [
          'SearchPanel'
      ],
