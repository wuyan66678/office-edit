...
define([
    ...
    Common.Views.Protection = Common.UI.BaseView.extend(_.extend((function(){
        var template =
            ...
            '<div class="group">' +
                '<span id="slot-btn-add-password" class="text x-huge"></span>' +
                '<span id="slot-btn-change-password" class="text x-huge"></span>' +
                '<span id="slot-btn-signature" class="text x-huge"></span>' +
            '</div>' +
            '</section>';
