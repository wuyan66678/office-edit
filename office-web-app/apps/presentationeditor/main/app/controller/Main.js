    ...
    PE.Controllers.Main = Backbone.Controller.extend(_.extend((function() {
        ...
        return {
                ...
                if (this.api){
                    ...
                    $(document.body).on('blur', 'input, textarea', function(e) {
                        if (!Common.Utils.ModalWindow.isVisible()) {
                            ...
                            if (me.getApplication().getController('Viewport').getView('LeftMenu').getMenu('file').isVisible())
                                return;
                            if (!e.relatedTarget ||
                ...
                if (data.doc) {
                    ...
                    docInfo.asc_putIsEnabledPlugins(!!enable);
										...
										if (data.editorConfig && data.editorConfig.mode === 'view' && data.doc.hidePreviewToolBar) {
											$('#toolbar, #left-menu, #app-title').css('visibility', 'hidden')
											$('#viewport').css('background-color', '#f6f7f8')
										}
                }
            ...
            onDocumentContentReady: function() {
                ...
                viewportController.getView('LeftMenu').getMenu('file').loadDocument({doc:me.document});
                leftmenuController.setMode(me.appOptions).createDelayedElements().setApi(me.api);
                // viewportController.getView('LeftMenu').showHidePanel('thumbnails')
                searchController.setMode(me.appOptions).setApi(me.api);
              
                comRightmenuController.setApi(me.api).setMode(me.appOptions);
                comRightmenuController.getView('Common.Views.RightMenu').setApi(me.api).setMode(me.appOptions).loadDocument({doc:me.document});
                ...
                viewportController.getView('LeftMenu').disableMenu('all',false);
...
//                    me.getStore('SlideLayouts');
            ...
            onError: function(id, level, errData) {
                ...
                (id!==undefined) && Common.component.Analytics.trackEvent('Internal Error', id.toString());
						...
						onImgUploadSuccess: function () {
							this.api._doRecordCollaboration('插入图片')
						},
...
//
            ...
            onMeta: function(meta) {
                ...
                var filemenu = this.getApplication().getController('Viewport').getView('LeftMenu').getMenu('file');
            ...
            onConvertEquationToMath: function(equation) {
                ...
                win.$window.find('#id-equation-convert-help').on('click', function (e) {
                    win && win.close();
                    me.getApplication().getController('Viewport').getView('LeftMenu').showMenu('file:help', 'UsageInstructions\/InsertEquation.htm#convertequation');
                })
            },
