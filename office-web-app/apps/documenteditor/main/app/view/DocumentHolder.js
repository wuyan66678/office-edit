...
//                    style: 'word-wrap: break-word;'
            ...
            var onMouseMove = function(moveData) {
                ...
                if (moveData) {
                    ...
                    /** coauthoring begin **/
                        ...
                        // ToolTip = getUserName(moveData.get_UserId()) + me.tipIsLocked;
                        //改造--
                        ...
                        if (showPoint[1] > me._XY[1] && showPoint[1]+me._TtHeight < me._XY[1]+me._Height)  {
                            ...
                            src.append(`<div>请联系该用户保存或改为共同编辑模式</div>`)
        ...
        createDelayedElements: function() {
            ...
            this.menuOriginalSize = new Common.UI.MenuItem({
                ...
                if (me.api){
                    ...
                    me.fireEvent('editcomplete', this);
										me.api._doRecordCollaboration('图片设置：实际大小');
                }
            });
            ...
            var paragraphVAlign = function(item, e) {
                if (me.api) {
                    ...
                    me.api.ImgApply(properties);
										me.api._doRecordCollaboration(`设置对象垂直对齐：${item.caption}`)
                }
            };
        ...
        onImgRotate: function(item) {
            ...
            this.fireEvent('editcomplete', this);
						this.api._doRecordCollaboration(`设置图片旋转：${item.caption}`)
        },
        ...
        onImgFlip: function(item) {
            ...
            this.api.ImgApply(properties);
            this.fireEvent('editcomplete', this);
						this.api._doRecordCollaboration(`设置对象旋转：${item.caption}`)
        },
