        ...
        SSE.Views.Statusbar = Common.UI.BaseView.extend(_.extend({
            ...
            render: function () {
                ...
                this.boxMath.hide();
								...
								this.versionBox = $('#status-version', this.el);
            ...
            updateTabbarBorders: function() {
                ...
                if (this.boxFiltered.is(':visible')) {
                    ...
                    visible = true;
								...
								this.versionBox.css({'right': right + 10 + 'px'})
                if (this.isCompact) {
										if(this.versionBox.is(':visible')) {
											right += parseInt(this.versionBox.css('width')) + 20;
										}
            ...
            onBtnClick: function(event) {
                ...
                if (this.options.handler) {
                    this.options.handler.call(this,
                        event.currentTarget.attributes['result'].value, active.get('inindex'), active.get('value'));
                }
