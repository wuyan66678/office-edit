...
Common.Utils.InternalSettings.set('toolbar-height-tabs', 54);   // 预览模式toolbar 高度
Common.Utils.InternalSettings.set('toolbar-height-tabs-top-title', 54);  // toolbar 上半部分
Common.Utils.InternalSettings.set('toolbar-height-controls', 80); // toolbar 下半部分
Common.Utils.InternalSettings.set('document-title-height', 0);   // 文档名高度
