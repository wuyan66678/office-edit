...
CWordCollaborativeEditing.prototype.Send_Changes = function(IsUserSave, AdditionalInfo, IsUpdateInterface, isAfterAskSave)
{
    ...
    // Генерируем свои изменения 产生自己的变化
    ...
    {
        // Чистим Undo/Redo только во время совместного редактирования 只有在联合编辑期间
    ...
    // TODO: Пока у нас обнуляется история на сохранении нужно обновлять Undo/Redo 只要我们的历史是零，我们就需要更新
