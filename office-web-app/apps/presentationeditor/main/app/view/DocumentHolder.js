                ...
                if (moveData) {
                    ...
                    /** coauthoring begin **/
                        ...
                        // ToolTip = getUserName(moveData.get_UserId());
                         //改造--
                         ToolTip = `此元素已被${getUserName(moveData.get_UserId())}锁定`
        ...
        createDelayedElements: function(){
            ...
            var mnuResetSlide = new Common.UI.MenuItem({
                ...
                if (me.api){
                    ...
                    Common.component.Analytics.trackEvent('DocumentHolder', 'Reset Slide');
										window['_PostActionContent'] && window['_PostActionContent']('重置幻灯片');
                }
            });
            ...
            var mnuMoveSlideToStart = new  Common.UI.MenuItem({
                ...
                if (me.api) {
                    ...
                    Common.component.Analytics.trackEvent('DocumentHolder', 'Move Slide to Start');
										var current = me.api.getCurrentPage() + 1;
										window['_PostActionContent'] && window['_PostActionContent'](`将幻灯片${current}移至开头`);
                }
            });
            ...
            var mnuMoveSlideToEnd = new  Common.UI.MenuItem({
                ...
                if (me.api) {
                    ...
                    Common.component.Analytics.trackEvent('DocumentHolder', 'Move Slide to End');
										var current = me.api.getCurrentPage() + 1;
										window['_PostActionContent'] && window['_PostActionContent'](`将幻灯片${current}移至终点`)
                }
            });
            ...
            var mnuSlideHide = new Common.UI.MenuItem({
                ...
                if (me.api){
                    me.api.asc_HideSlides(item.checked);
										window['_PostActionContent']('隐藏幻灯片');
                    me.fireEvent('editcomplete', me);
            ...
            me.slideMenu = new Common.UI.Menu({
                ...
                initMenu: function(value) {
                    ...
                    me.slideMenu.items[12].setVisible((!selectedLast || !selectedFirst) && value.isSlideSelect===true);
                    ...
                    me.slideMenu.items[15].setVisible(value.fromThumbs===true);
                    // me.slideMenu.items[17].setVisible(value.fromThumbs===true);//无17？
                    ...
                    new Common.UI.MenuItem({
                        ...
                        if (me.api) {
                            ...
                            me.api.DublicateSlide();
														window['_PostActionContent']('重复幻灯片');
                            me.fireEvent('editcomplete', me);
                ...
                me.slideLayoutMenu = new Common.UI.DataView({
                    ...
                    if (me.api) {
                        ...
                        Common.component.Analytics.trackEvent('DocumentHolder', 'Change Layout');
												var current = me.api.getCurrentPage() + 1;
												window['_PostActionContent'] && (window['_PostActionContent'](`更改幻灯片${current}版式为：${record.attributes.title}`));
                    }
                });
                ...
                me.slideThemeMenu = new Common.UI.DataView({
                    ...
                    if (me.api) {
                        ...
                        Common.component.Analytics.trackEvent('DocumentHolder', 'Change Theme');
												var current = me.api.getCurrentPage() + 1;
												window['_PostActionContent'](`设置幻灯片${current}主题为：${record.attributes.tip}`);
                    }
                });
                    ...
                    function onItemClick(item) {
                        if (me.api) {
                            ...
                            me.api.ShapeApply(properties);
														me.api._doRecordCollaboration(`设置对象对齐方式：${item.caption}`)
                        }
            ...
            var paragraphDirection = function(item, e) {
                if (me.api) {
                    ...
                    me.api.ShapeApply(properties);
										me.api._doRecordCollaboration(`设置对象文字方向：${item.caption}`)
                }
                me.fireEvent('editcomplete', me);
