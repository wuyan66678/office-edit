...
/**
 * Очищение форматирования параграфа 清理段落格式
 */
...
{
	/**
	 * 因为这个项目被删除了，所以我们需要删除关于
		在本段落中使用的育儿类中的inline对象。
		此外，如果喜剧在这里开始或结束，他们也一样。
		删除。
	 * 
	 */
