...
define([
    ...
    DE.Controllers.Navigation = Backbone.Controller.extend(_.extend({
        ...
        onItemContextMenu: function(picker, item, record, e){
            ...
            //改造--新增导航删除功能
            menu.items[13].setDisabled(isNotHeader || this._isDisabled)
            menu.items[13].setVisible(this.mode.isEdit)
        ...
        onMenuItemClick: function (menu, item) {
            ...
            }else if (item.value == 'delete') { //改造--删除内容
                this._navigationObject.SelectAndDeleteContent(index)
