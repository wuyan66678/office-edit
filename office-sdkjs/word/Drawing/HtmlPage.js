...
function CEditorPage(api)
{
	...
	this.Init = function()
	{
		...
		var hor_scroll          = document.getElementById('id_horscrollpanel');
			hor_scroll.style.zIndex = 0;//修改word的滚动条层级
		...
		this.m_oPanelRight.HtmlElement.style.zIndex = 0 //修改word的滚动条层级
		// --------------------------------------------------------------------------
		...
		this.m_oDrawingDocument.TargetHtmlElement.style.zIndex = 1 //修改word的滚动条层级
