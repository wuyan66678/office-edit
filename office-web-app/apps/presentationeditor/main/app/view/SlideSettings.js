    ...
    PE.Views.SlideSettings = Backbone.View.extend(_.extend({
        ...
        onFillSrcSelect: function(combo, record) {
            ...
            this.fireEvent('editcomplete', this);
						var current = this.api.getCurrentPage() + 1;
						window['_PostActionContent'] && window['_PostActionContent'](`设置幻灯片${current}背景：${record.displayValue}`)
        },
        ...
        onColorsBackSelect: function(btn, color) {
            ...
            if (this.api && !this._noApply) {
                ...
                this.api.SetSlideProps(props);
								var current = this.api.getCurrentPage() + 1;
								window['_PostActionContent'] && window['_PostActionContent'](`设置幻灯片${current}填充色：#${color.color || color}`)
            }
            this.fireEvent('editcomplete', this);
        },
        ...
        onColorsFGSelect: function(btn, color) {
            ...
            if (this.api && !this._noApply) {
                ...
                this.api.SetSlideProps(props);
								var current = this.api.getCurrentPage() + 1;
								window['_PostActionContent'](`设置幻灯片${current}前景色：#${color.color || color}`)
            }
            this.fireEvent('editcomplete', this);
        },
        ...
        onColorsBGSelect: function(btn, color) {
            ...
            if (this.api && !this._noApply) {
                ...
                this.api.SetSlideProps(props);
								var current = this.api.getCurrentPage() + 1;
								window['_PostActionContent'](`设置幻灯片${current}背景色：#${color.color || color}`)
            }
            this.fireEvent('editcomplete', this);
        },
        ...
        onColorsGradientSelect: function(btn, color) {
            ...
            if (this.api && !this._noApply) {
                ...
                this.api.SetSlideProps(props);
								...
								window['_PostActionContent'](`设置幻灯片${current}渐变色：#${color.color || color}`)
            }
            this.fireEvent('editcomplete', this);
        },
