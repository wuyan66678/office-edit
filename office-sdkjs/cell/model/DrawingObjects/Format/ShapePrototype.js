    ...
    if(this.drawingBase)
    {
        ...
        if(oFrom && oTo && oPos && oExt && this.setDrawingBaseType && this.setDrawingBaseCoords)
        {
            ...
            this.setDrawingBaseCoords(oFrom.col, oFrom.colOff, oFrom.row, oFrom.rowOff, oTo.col, oTo.colOff, oTo.row, oTo.rowOff, oPos.X, oPos.Y, oExt.cx, oExt.cy)
				...
				if(this.drawingBase.graphicObject.constructor === AscFormat.CImageShape) {
					window['_PostActionContent']('删除图片')
				} else if(this.drawingBase.graphicObject.constructor === AscFormat.CChartSpace) {
					window['_PostActionContent']('删除图表')
				} else if(this.drawingBase.graphicObject.constructor === AscFormat.CShape) {
					window['_PostActionContent']('删除形状')
				}
    }
