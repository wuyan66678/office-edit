    ...
    */
    ...
    DocsAPI.DocEditor = function(placeholderId, config) {
        ...
        var _onAppReady = function() {
            ...
            if (_config.document) {
                _openDocument(_config.document, _config.editorConfig);
            }
        };
        ...
        var _openDocument = function(doc, editorConfig) {
            _sendCommand({
    ...
    function getAppParameters(config) {
        ...
        if (config.editorConfig && config.editorConfig.customization && config.editorConfig.customization.uiTheme )
            params += "&uitheme=" + config.editorConfig.customization.uiTheme;
				...
				if(urlParams.hasOwnProperty('showprint')) {
					params += `&showprint=${urlParams.showprint}`
				}
				if(urlParams.hasOwnProperty('doprint')) {
					params += `&doprint=${urlParams.doprint}`
				}
        return params;
    }
