...
define([
    ...
    DE.Views.LeftMenu = Backbone.View.extend(_.extend({
        ...
        render: function () {
            ...
            this.btnNavigation.on('click', _.bind(this.onBtnMenuClick, this, 'tab'));
            ...
            this.btnThumbnails.on('click',  _.bind(this.onBtnMenuClick, this));
            ...
            this.btnNavigationIcon  = new Common.UI.Button({
                el: $markup.elementById('#left-btn-navigation-icon'),
                action: 'navigation',
                hint: this.tipNavigation
            });
            ...
            this.btnNavigationIcon.on('click', _.bind(this.onBtnMenuClick, this, 'icon'));
        ...
        addMenuLabel: function (){
            var _this  = this;
            _this.btnNavigation.$el.text(_this.tipNavigation)
        ...
        onBtnMenuToggle: function(btn, state) {
            console.log('onBtnMenuToggle=', btn,state);
            if (state) {
                btn.panel['show']();
        ...
        onBtnMenuClick: function(type = '',btn, e) {
            ...
            // this.btnAction 存在，且btn.options.action 还是点击同一个，去关闭，且return了不往下执行
            ...
            // this.btnAction 存在，且btn.options.action 不是同一个，切换面板，不关闭,this.btnAction为新的
            ...
            if (btn.options.action == 'search') {
                this.btnNavigation.pressed = false;
                this.btnThumbnails.pressed = false;
                this.btnChat.pressed = false;
                this.btnComments.pressed = false;
                $("#left-btn-comments").removeClass("active")
                $("#left-btn-navigation").removeClass("active")
        ...
        onWindowResize: function() {
            console.log('doc onWindowResize');
