...
//改造--选中并删除内容
CDocumentOutline.prototype.SelectAndDeleteContent = function(nIndex)
{
	if (nIndex < 0 || nIndex >= this.Elements.length)
		return;
	...
	this.LogicDocument.DeleteSelection()
...
CDocumentOutline.prototype["SelectAndDeleteContent"]        = CDocumentOutline.prototype.SelectAndDeleteContent;
